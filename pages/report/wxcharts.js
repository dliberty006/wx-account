...
var config = {
    ...
    colors: ['#7cb5ec','#f7a35c','#434348','#90ed7d','#f15c80','#8085e9','#ff8c31','#00bc12',                            '#ffc64b','#c83c23','#003371','#392f41','#ff0097','#c32136','#000000','#bf242a',
             '#493131','#75664d','#7bcfa6','#ef7a82','#56004f','#ff3300','#e29c45','#8b968d',
             '#7a4171','#767c6b','#f5b199','#bc763c','#956f29','#44617b','#203744','#c14ce9'],
...
function drawPieText(series, opts, config, context, radius, center) {
    ...
    var seriesConvert = series.map(function (item) {
        ...
        var text = item.format ? item.format(util.toFixed(item._proportion_)) : item.name+"("+item.data/100+")";
